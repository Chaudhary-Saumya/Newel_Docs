...
echo "#############################################"
echo ""
echo "This script will download, configure and start Newel Docs."
...
wget "https://raw.githubusercontent.com/newel-docs/newel-docs/main/docker/compose/docker-compose.$DOCKER_COMPOSE_VERSION.yml" -O docker-compose.yml
